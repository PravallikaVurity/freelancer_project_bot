...
const { updateProposalStatus, withdrawProposal, getMyProposals, uploadVoiceProposal, getFreelancerAnalytics } = require("../controllers/proposalController");
const { protect, authorize } = require("../middleware/auth");
const { audioUpload } = require("../config/cloudinary");

router.get("/my", protect, getMyProposals);
router.get("/analytics", protect, authorize("freelancer"), getFreelancerAnalytics);
